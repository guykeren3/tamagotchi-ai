...
function buildSystemPrompt(petState) {
  const { stage, mood, hunger, happiness, energy, hygiene, health, variant, accessory, totalTime } = petState;
...
app.listen(PORT, () => {
  console.log(`🐣 Tamagotchi AI server running on http://localhost:${PORT}`);
